...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('tpo_doc.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="tpo_doc" sortable="true">Tipo Documento</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('tpo_doc-create')) 
		{{ link_to_route('tpo_doc.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
