...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('rev_requisito.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('rev_requisito-create')) 
		{{ link_to_route('rev_requisito.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		@endif
		@if (Sentry::getUser()->hasAccess('rev_requisitos-imprimir')) 
...
<script type="text/javascript">
    ...
    function lineas(){
		...
		if (row){
			...
			url="{{url('rev_requisito/lineas', $parameters=array(), $secure=null)}}"+"/"+row.id;
			/*$(location).attr('href',url);*/
