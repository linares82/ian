...
{{ Form::model($rev_requisito, array('class' => 'form', 'method' => 'PUT', 'url' => 'rev_requisito/update/'.$rev_requisito->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('rev_requisito.index', 'Cancelar', $rev_requisito->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
