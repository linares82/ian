...
{{ Form::open(array('route' => 'menus.store', 'class' => 'form')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        <div title="CREAR" style="padding:10px;">  
            ...
            <div class="row_1 @if ($errors->has('orden')) has-error @endif">
                {{ Form::label('orden', 'Orden:', array('class'=>'')) }}
            ...
            <div class="row_1 @if ($errors->has('link')) has-error @endif" style="clear:left;">
            ...
            <div class="row_buttons">
                  ...
                  {{ link_to_route('menus.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
            </div>
        </div>
    </div>
{{ Form::close() }}
