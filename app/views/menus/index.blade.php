...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('menus.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="item" sortable="true">Item</th>
				<th field="orden" sortable="true">Orden</th>
				<th field="depende_de" sortable="true">Depende de</th>
				<th field="link" sortable="true">Link</th>
				<th field="permiso_id" sortable="true">Permiso</th>
				<th field="target" sortable="true">Target</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('menus-create')) 
		{{link_to_route('menus.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		@if (Sentry::getUser()->hasAccess('menus-edit')) 
		<a href="#" class="easyui-linkbutton" iconCls="icon-modify" plain="true" onclick="editReg()">Editar</a>
		@endif
		@if (Sentry::getUser()->hasAccess('menus-show'))
		...
		@endif
		@if (Sentry::getUser()->hasAccess('menus-recover'))
