...
{{ Form::model($a_comentarios_nc, array('class' => 'form', 'method' => 'PUT', 'url' => 'a_comentarios_nc/update/'.$a_comentarios_nc->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ( $errors->has('no_confomrmidad_id')) has-error @endif">
            {{ Form::label('no_confomrmidad_id', 'No_confomrmidad_id:') }}
              {{ Form::input('number', 'no_confomrmidad_id', Input::old('no_confomrmidad_id')) }}
            {{ $errors->first('no_confomrmidad_id', '<div class="errorMessage">:message</div>') }}
        </div>
...
<div class="row_buttons">
  ...
  {{ link_to_route('a_comentarios_nc.index', 'Cancelar', $a_comentarios_nc->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
