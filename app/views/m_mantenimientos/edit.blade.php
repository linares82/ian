...
rel="stylesheet" 
type="text/css" 
href = "{{ asset('datetimepicker/build/jquery.datetimepicker.css') }}"
/>
...
<div class="easyui-tabs" style="width:auto;height:auto;">
    <div title="Editar" style="padding:10px;"> 
        ...
        <div class="row_1 @if ( $errors->has('fec_inicio')) has-error @endif" >
            ...
            {{Form::text('fec_inicio', Input::old('fec_inicio'), array('placeholder'=>'fec_inicio', 'style'=>'width:85%')) }}
        ...
        <div class="row_1 @if ( $errors->has('fec_final')) has-error @endif" >
            ...
            {{ Form::text('fec_final', Input::old('fec_final'), array('placeholder'=>'fec_final', 'style'=>'width:85%')) }}
...
<script type="text/javascript">
    ...
    $('#fec_inicio').datetimepicker({
            ...
            value:'{{$m_mantenimiento->fec_inicio}}',
    });
    $('#fec_final').datetimepicker({
            datepicker:true,
            timepicker:true,
            lang:'es',
            formatTime:'H:i',
