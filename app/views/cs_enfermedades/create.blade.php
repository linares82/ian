...
{{ Form::open(array('route' => 'cs_enfermedade.store', 'class' => 'form')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('cs_enfermedade.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
