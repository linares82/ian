...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('ca_tpo_inconformidad.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="tpo_inconformidad" sortable="true">Tipo inconformidad</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('ca_tpo_inconformidad-create')) 
		{{ link_to_route('ca_tpo_inconformidad.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
