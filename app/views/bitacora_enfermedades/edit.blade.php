...
{{ Form::model($bitacora_enfermedade, array('class' => 'form', 'method' => 'PUT', 'url' => 'bitacora_enfermedade/update/'.$bitacora_enfermedade->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('bitacora_enfermedade.index', 'Cancelar', $bitacora_enfermedade->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
