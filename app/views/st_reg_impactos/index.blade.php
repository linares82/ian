...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('st_reg_impacto.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('st_reg_impacto-create')) 
		{{ link_to_route('st_reg_impacto.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
