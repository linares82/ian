...
{{ Form::open(array('route' => 'st_reg_impacto.store', 'class' => 'form')) }}
            ...
            <div class="col-sm-10">
              {{ Form::input('number', 'usu_mod_id', Input::old('usu_mod_id'), array('class'=>'form-control')) }}
				...
				<div class="row_buttons">
					  ...
					  {{ link_to_route('st_reg_impacto.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
				</div>
			</div>
    </div>
