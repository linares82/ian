...
{{ Form::open(array('route' => 'bitacora_seguridad.store', 'class' => 'form', 'id'=>'f_bitacora_seguridad')) }}
	...
	<div class="row_buttons">
				  ...
				  {{ link_to_route('bitacora_seguridad.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
			</div>
		</div>
</div>
