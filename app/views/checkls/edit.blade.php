...
{{ Form::model($checkl, array('class' => 'form', 'method' => 'PUT', 'url' => 'checkl/update/'.$checkl->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div id="p" class="easyui-panel" title="DATOS INICIALES" style="width:96%;margin-top:10px;margin-bottom:15px;">
        </div>
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('checkl.index', 'Cancelar', array('id'=>$checkl->check_id), array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
