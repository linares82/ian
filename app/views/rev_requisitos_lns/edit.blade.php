...
{{ Form::model($rev_requisitos_ln, array('class' => 'form', 'method' => 'POST', 
            'url' => 'rev_requisitos_ln/update/'.$rev_requisitos_ln->id, 
            'id'=>'f_rev_requisitos_ln')) }}
...
<div class="row @if ( $errors->has('impacto_id')) has-error @endif">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('rev_requisitos_ln.index', 'Cancelar', array('id'=>$rev_requisitos_ln->rev_requisitos_id), array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
