...
{{ Form::model($importancium, array('class' => 'form', 'method' => 'PUT', 'url' => 'importancium/update/'.$importancium->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ( $errors->has('importancia')) has-error @endif">
            {{ Form::label('importancia', 'Importancia:') }}
              {{ Form::text('importancia', Input::old('importancia'), array('placeholder'=>'Importancia')) }}
            {{ $errors->first('importancia', '<div class="errorMessage">:message</div>') }}
        </div>
...
<div class="row_buttons">
  ...
  {{ link_to_route('importancium.index', 'Cancelar', $importancium->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
