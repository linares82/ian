...
{{ Form::model($a_no_conformidade, array('class' => 'form', 'method' => 'POST', 'url' => 'a_no_conformidade/update/'.$a_no_conformidade->id, 'id'=>'f_no_conformidad')) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('a_no_conformidade.index', 'Cancelar', $a_no_conformidade->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
