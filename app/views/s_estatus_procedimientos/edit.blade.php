...
{{ Form::model($s_estatus_procedimiento, array('class' => 'form', 'method' => 'PUT', 'url' => 's_estatus_procedimiento/update/'.$s_estatus_procedimiento->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('s_estatus_procedimiento.index', 'Cancelar', $s_estatus_procedimiento->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
