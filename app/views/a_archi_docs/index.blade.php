...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('a_archi_doc.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('a_archi_doc-create')) 
		{{ link_to_route('a_archi_doc.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
