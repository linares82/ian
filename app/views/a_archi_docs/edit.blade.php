...
{{ Form::model($a_archi_doc, array('class' => 'form', 'method' => 'PUT', 'url' => 'a_archi_doc/update/'.$a_archi_doc->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('a_archi_doc.index', 'Cancelar', $a_archi_doc->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
