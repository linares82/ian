...
{{ Form::model($m_estatus, array('class' => 'form', 'method' => 'PUT', 'url' => 'm_estatus/update/'.$m_estatus->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('m_estatus.index', 'Cancelar', $m_estatus->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
