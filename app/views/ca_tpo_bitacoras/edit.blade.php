...
{{ Form::model($ca_tpo_bitacora, array('class' => 'form', 'method' => 'PUT', 'url' => 'ca_tpo_bitacora/update/'.$ca_tpo_bitacora->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('ca_tpo_bitacora.index', 'Cancelar', $ca_tpo_bitacora->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
