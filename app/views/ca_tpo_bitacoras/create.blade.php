...
{{ Form::open(array('route' => 'ca_tpo_bitacora.store', 'class' => 'form')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('ca_tpo_bitacora.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
