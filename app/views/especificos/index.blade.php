...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('especifico.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="especifico" sortable="true">Específico</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('especifico-create')) 
		{{ link_to_route('especifico.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		<div>
			...
			Especifico: <input id="especificoBox" class="easyui-textbox" style="width:80px">
