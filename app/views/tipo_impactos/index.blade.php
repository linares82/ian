...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('tipo_impacto.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('tipo_impacto-create')) 
		{{ link_to_route('tipo_impacto.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		<div>
			...
			Tipo de Impacto: <input id="tipo_impactoBox" class="easyui-textbox" style="width:80px">
...
<script type="text/javascript">
	...
	function doSearch(){
	    $('#dg').datagrid('load',{
		    id: $('#idbox').val(),
		    tipo_impacto:$('#tipo_impactoBox').val(),
	    });
    }
