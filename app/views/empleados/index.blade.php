...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('empleado.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="nombre" sortable="true">Nombre</th>
				<th field="area" sortable="true">Area</th>
				<th field="puesto" sortable="true">Puesto</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('empleado-create')) 
		{{ link_to_route('empleado.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
