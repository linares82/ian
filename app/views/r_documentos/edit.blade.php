...
{{ Form::model($r_documento, array('class' => 'form', 'method' => 'PUT', 'url' => 'r_documento/update/'.$r_documento->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('r_documento.index', 'Cancelar', $r_documento->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
