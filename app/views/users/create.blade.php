...
{{ Form::open(array('route' => 'user.store', 'class' => 'form')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1">
            ...
            <input id="no" name="multi_entidad" type="radio" style="width:20%; float:left;" value="no" {{ ('multi_entidad' === false) ? 'checked' : '' }}>
            <label for="no" onclick="" style="width:20%; float:left;">No</label>
            <input id="yes" name="multi_entidad" type="radio" style="width:20%; float:left;" value="yes" {{ ('multi_entidad' === true) ? 'checked' : '' }}>
            <label for="yes" onclick="" style="width:20%; float:left;">Si</label>
        </div>

        <div class="row_1 @if ($errors->has('entidad_id')) has-error @endif" style="clear:left">
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('user.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
			</div>
    </div>
