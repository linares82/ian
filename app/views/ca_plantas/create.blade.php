...
{{ Form::open(array('route' => 'ca_planta.store', 'class' => 'form')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ( $errors->has('tipo_planta')) has-error @endif">
            {{ Form::label('tipo_planta', 'Tipo Planta:') }}
              {{ Form::text('tipo_planta', Input::old('tipo_planta'), array('placeholder'=>'TipoPlanta')) }}
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('ca_planta.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
