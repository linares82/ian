...
{{ Form::model($mese, array('class' => 'form', 'method' => 'PUT', 'url' => 'mese/update/'.$mese->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('mese.index', 'Cancelar', $mese->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
