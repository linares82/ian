...
{{ Form::model($s_registro, array('class' => 'form', 'method' => 'POST', 'url' => 's_registro/update/'.$s_registro->id, 'files'=>true, 'id'=>'f_registros')) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('s_registro.index', 'Cancelar', $s_registro->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
