...
{{ Form::open(array('route' => 'cs_elementos_inspeccion.store', 'class' => 'form', 'id'=>'f_elementos_inspeccion')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('cs_elementos_inspeccion.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
