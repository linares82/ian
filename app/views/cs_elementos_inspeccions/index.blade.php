...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('cs_elementos_inspeccion.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="grupo_norma" sortable="true">G. Norma</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('cs_elementos_inspeccion-create')) 
		{{ link_to_route('cs_elementos_inspeccion.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
