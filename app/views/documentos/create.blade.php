...
{{ Form::model($documento, array('route' => 'documento.store', 'class' => 'form', 'files' => true)) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('documento.index', 'Cancelar', array('id'=>$documento->enc_impacto_id), array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
