...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('documento.contentListIndex', array('id'=>$enc_impacto))}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true" hidden="true">id</th>
				<th field="documento" sortable="true">Documento</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('documento-create')) 
		{{ link_to_route('documento.create', 'Crear', array('id'=>$enc_impacto), array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
