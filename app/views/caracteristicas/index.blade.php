...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('caracteristica.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('caracteristica-create')) 
		{{ link_to_route('caracteristica.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		<div>
			...
			Caracteristica: <input id="caracteristicaBox" class="easyui-textbox" style="width:80px">
...
<script type="text/javascript">
	...
	function doSearch(){
	    $('#dg').datagrid('load',{
		    id: $('#idbox').val(),
		    caracteristica: $('#caracteristicaBox').val(),
	    });
    }
