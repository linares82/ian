...
{{ Form::model($estatus_condicione, array('class' => 'form', 'method' => 'PUT', 'url' => 'estatus_condicione/update/'.$estatus_condicione->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('estatus_condicione.index', 'Cancelar', $estatus_condicione->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
