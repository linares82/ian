...
{{ Form::model($a_st_nc, array('class' => 'form', 'method' => 'PUT', 'url' => 'a_st_nc/update/'.$a_st_nc->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('a_st_nc.index', 'Cancelar', $a_st_nc->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
