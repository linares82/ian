...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('cs_norma.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('cs_norma-create')) 
		{{ link_to_route('cs_norma.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
