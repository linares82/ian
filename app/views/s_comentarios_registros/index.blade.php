...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('s_comentarios_registro.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('s_comentarios_registro-create')) 
		{{ link_to_route('s_comentarios_registro.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
