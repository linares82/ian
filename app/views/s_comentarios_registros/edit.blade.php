...
{{ Form::model($s_comentarios_registro, array('class' => 'form', 'method' => 'PUT', 'url' => 's_comentarios_registro/update/'.$s_comentarios_registro->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ( $errors->has('s_registros_id')) has-error @endif">
            {{ Form::label('s_registros_id', 'S_registros_id:') }}
              {{ Form::input('number', 's_registros_id', Input::old('s_registros_id')) }}
            {{ $errors->first('s_registros_id', '<div class="errorMessage">:message</div>') }}
        </div>
...
<div class="row_buttons">
  ...
  {{ link_to_route('s_comentarios_registro.index', 'Cancelar', $s_comentarios_registro->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
