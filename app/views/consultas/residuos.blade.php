...
{{ Form::open(array('route' => 'consulta.residuo', 'class' => 'form', 'method' => 'POST')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_2 @if ( $errors->has('residuo_f')) has-error @endif">
            {{ Form::label('residuo_f', 'Residuo de:') }}
              {{ Form::select('residuo_f', $residuos_ls, Input::old('residuo_f'))  }}
            {{ $errors->first('residuo_f', '<div class="errorMessage">:message</div>') }}
        </div>
        <div class="row_2 @if ( $errors->has('residuo_t')) has-error @endif">
            {{ Form::label('residuo_t', 'Residuo a:') }}
              {{ Form::select('residuo_t', $residuos_ls, Input::old('residuo_t'))  }}
            {{ $errors->first('residuo_t', '<div class="errorMessage">:message</div>') }}
        </div>
