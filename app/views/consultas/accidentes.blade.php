...
{{ Form::open(array('route' => 'consulta.accidente', 'class' => 'form', 'method' => 'POST')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_2 @if ( $errors->has('accidente_f')) has-error @endif">
            {{ Form::label('accidente_f', 'Accidente de:') }}
              {{ Form::select('accidente_f', $accidentes_ls, Input::old('accidente_f'))  }}
            {{ $errors->first('accidente_f', '<div class="errorMessage">:message</div>') }}
        </div>
        <div class="row_2 @if ( $errors->has('accidente_t')) has-error @endif">
            {{ Form::label('accidente_t', 'Accidente a:') }}
              {{ Form::select('accidente_t', $accidentes_ls, Input::old('accidente_t'))  }}
            {{ $errors->first('accidente_t', '<div class="errorMessage">:message</div>') }}
        </div>
