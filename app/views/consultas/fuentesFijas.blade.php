...
{{ Form::open(array('route' => 'consulta.fuenteFija', 'class' => 'form', 'method' => 'POST')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_2 @if ( $errors->has('fuente_f')) has-error @endif">
            {{ Form::label('fuente_f', 'Fuente Fija de:') }}
              {{ Form::select('fuente_f', $fuentes_fijas_ls, Input::old('fuente_f'))  }}
            {{ $errors->first('fuente_f', '<div class="errorMessage">:message</div>') }}
        </div>
        <div class="row_2 @if ( $errors->has('fuente_t')) has-error @endif">
            {{ Form::label('fuente_t', 'Fuente Fija a:') }}
              {{ Form::select('fuente_t', $fuentes_fijas_ls, Input::old('fuente_t'))  }}
            {{ $errors->first('fuente_t', '<div class="errorMessage">:message</div>') }}
        </div>
