...
{{ Form::model($aa_condicione, array('class' => 'form', 'method' => 'PUT', 'url' => 'aa_condicione/update/'.$aa_condicione->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('aa_condicione.index', 'Cancelar', $aa_condicione->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
