...
{{ Form::model($s_documento, array('class' => 'form', 'method' => 'PUT', 'url' => 's_documento/update/'.$s_documento->id, 'files'=>true)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('s_documento.index', 'Cancelar', $s_documento->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
