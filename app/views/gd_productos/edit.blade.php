...
{{ Form::model($gd_producto, array('class' => 'form', 'method' => 'PUT', 'url' => 'gd_producto/update/'.$gd_producto->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
		...
		<div class="row_buttons">
		  ...
		  {{ link_to_route('gd_producto.index', 'Cancelar', $gd_producto->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
		</div>
