...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('gd_producto.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="producto" sortable="true">Producto</th>
				<th field="abreviacion" sortable="true">Abreviación</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('gd_producto-create')) 
		{{ link_to_route('gd_producto.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		<div>
			...
			Producto: <input id="productoBox" class="easyui-textbox" style="width:250px">
			Abreviación: <input id="abreviacionBox" class="easyui-textbox" style="width:100px">
...
<script type="text/javascript">
	...
	function doSearch(){
	    $('#dg').datagrid('load',{
		    id: $('#idbox').val(),
			producto: $('#productoBox').val(),
			abreviacion: $('#abreviacionBox').val(),
	    });
    }
