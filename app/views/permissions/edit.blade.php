...
{{ Form::model($permission, array('class' => 'form', 'method' => 'PUT', 'url' => 'permission/update/'.$permission->id, 'files' => true)) }}
    ...
    <div class="row_buttons">
      ...
      {{ link_to_route('permission.index', 'Cancelar', $permission->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
    </div>
