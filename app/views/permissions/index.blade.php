...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('permission.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
		...
		<thead>
			<tr>
				...
				<th field="value" sortable="true">Valor</th>
				<th field="description" sortable="true">Descripción</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('permissions-create')) 
		{{ link_to_route('permission.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		@endif
		@if (Sentry::getUser()->hasAccess('permissions-show')) 
		...
		@endif
		@if (Sentry::getUser()->hasAccess('permissions-recover')) 
