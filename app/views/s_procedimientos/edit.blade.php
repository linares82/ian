...
{{ Form::model($s_procedimiento, array('class' => 'form', 'method' => 'POST', 'url' => 's_procedimiento/update/'.$s_procedimiento->id, 'id'=>'f_procedimientos', 'files'=>true)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row @if ( $errors->has('archivo')) has-error @endif">
            {{ Form::label('archivo', 'Archivo:') }}
              ...
              {{ Form::text('archivo', Input::old('archivo'), array('readonly'=>'readonly')) }}
            {{ $errors->first('archivo', '<div class="errorMessage">:message</div>') }}
        </div>

        <div class="row_buttons">
          {{ Form::submit('Actualizar', array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
          {{ link_to_route('s_procedimiento.index', 'Cancelar', $s_procedimiento->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
