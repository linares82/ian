...
{{ Form::model($a_comentarios_archivo, array('class' => 'form', 'method' => 'PUT', 'url' => 'a_comentarios_archivo/update/'.$a_comentarios_archivo->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ( $errors->has('a_st_archivo_id')) has-error @endif">
            {{ Form::label('a_st_archivo_id', 'A_st_archivo_id:') }}
              {{ Form::input('number', 'a_st_archivo_id', Input::old('a_st_archivo_id')) }}
            {{ $errors->first('a_st_archivo_id', '<div class="errorMessage">:message</div>') }}
        </div>
...
<div class="row_buttons">
  ...
  {{ link_to_route('a_comentarios_archivo.index', 'Cancelar', $a_comentarios_archivo->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
