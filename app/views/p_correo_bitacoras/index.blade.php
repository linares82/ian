...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('p_correo_bitacora.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="bnd_enviar" sortable="true">Enviar</th>
				<th field="bitacora" sortable="true">Bitacora</th>
				<th field="nombre" sortable="true">Responsable</th>
				<th field="bnd_jefe" sortable="true">Enviar Jefe</th>
				<th field="dias_plazo" sortable="true">Dias Plazo Minimo</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('p_correo_bitacora-create')) 
		{{ link_to_route('p_correo_bitacora.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
