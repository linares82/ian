...
{{ Form::model($a_procedimiento, array('class' => 'form', 'method' => 'PUT', 'url' => 'a_procedimiento/update/'.$a_procedimiento->id, 'files'=>true)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row @if ( $errors->has('procedimiento_id')) has-error @endif">
            {{ Form::label('procedimiento_id', 'Procedimiento:') }}
              {{ Form::select('procedimiento_id', $procedimientos_ls, Input::old('procedimiento_id'))  }}
            {{ $errors->first('procedimiento_id', '<div class="errorMessage">:message</div>') }}
        </div>
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('a_procedimiento.index', 'Cancelar', $a_procedimiento->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
