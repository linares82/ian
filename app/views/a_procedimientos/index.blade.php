...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('a_procedimiento.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">id</th>
				<th field="procedimiento" sortable="true">Procedimiento</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('a_procedimiento-create')) 
		{{ link_to_route('a_procedimiento.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		<div>
			...
			Procedimiento:{{ Form::select('procedimiento_id', $procedimientos_ls, null, array('id'=>'procedimiento_id'))  }}
	...
	<div id="dlg" class="easyui-dialog" style="width:700px;height:300px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
        {{ Form::open(array('route' =>'a_procedimiento.comentarioEstatus', 'class' => 'form', 'id'=>'estatus_form')) }}
        	<div class="row">
		        ...
		        <div class="row">
		              {{ Form::hidden('a_procedimiento_id', Input::old('a_procedimiento_id'), array('value'=>'0', 'id'=>'a_archivo_id')) }}
		        </div>
		        ...
		        <div class="row">
		            {{ Form::hidden('a_st_procedimiento_id', Input::old('a_st_procedimiento_id'), array('value'=>'0', 'id'=>'a_st_procedimiento_id')) }}
		        </div>
...
<script type="text/javascript">
	...
	function stEnProceso(){
		...
		if (row){
			...
			$('#a_st_procedimiento_id').val('2');
			url="{{ route('a_procedimiento.comentarioEstatus') }}";
		}else{
	...
	function doSearch(){
	    $('#dg').datagrid('load',{
		    id: $('#idbox').val(),
		    procedimiento: $("select#procedimiento_id option:selected").val(),
