...
{{ Form::open(array('route' => 'enc_impacto.store', 'class' => 'form')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ($errors->has('proyecto')) has-error @endif">
            ...
            {{ Form::text('proyecto', Input::old('proyecto'), array('placeholder'=>'Proyecto')) }}
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('enc_impacto.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
