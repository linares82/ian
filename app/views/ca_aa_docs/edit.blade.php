...
{{ Form::model($ca_aa_doc, array('class' => 'form', 'method' => 'POST', 'url' => 'ca_aa_doc/update/'.$ca_aa_doc->id, 'id'=>'f_aa_doc')) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('ca_aa_doc.index', 'Cancelar', $ca_aa_doc->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
            ...
            $.ajax({
                ...
                success: function(categorias){
                    ...
                    $.each(categorias, function(i) {
                        $('select#categoria_id').append("<option "+categorias[i].selectec+" value=\""+categorias[i].categoria_id+"\">"+categorias[i].categoria+"<\/option>");
                    });
                }
            });
    }
