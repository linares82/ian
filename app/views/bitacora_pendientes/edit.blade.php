...
{{ Form::model($bitacora_pendiente, array('class' => 'form', 'method' => 'PUT', 'url' => 'bitacora_pendiente/update/'.$bitacora_pendiente->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('bitacora_pendiente.index', 'Cancelar', $bitacora_pendiente->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
