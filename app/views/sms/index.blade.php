...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('sm.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="monto" sortable="true">Monto Salario Mínimo</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
		...
		@endif
		@if (Sentry::getUser()->hasAccess('sm-show')) 
