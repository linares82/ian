...
{{ Form::model($turno, array('class' => 'form', 'method' => 'PUT', 'url' => 'turno/update/'.$turno->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ( $errors->has('turno')) has-error @endif">
            {{ Form::label('turno', 'Turno:') }}
              {{ Form::text('turno', Input::old('turno'), array('placeholder'=>'Turno')) }}
            {{ $errors->first('turno', '<div class="errorMessage">:message</div>') }}
        </div>
...
<div class="row_buttons">
  ...
  {{ link_to_route('turno.index', 'Cancelar', $turno->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
