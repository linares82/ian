...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('cs_grupo_norma.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="grupo_norma" sortable="true">Grupo Norma</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('cs_grupo_norma-create')) 
		{{ link_to_route('cs_grupo_norma.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
