...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('bitacora_residuo.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="residuo" sortable="true">Residuo</th>
				<th field="fecha" sortable="true">Fecha</th>
				<th field="cantidad" sortable="true">cantidad</th>
				<th field="ultima_captura" sortable="true" styler="cellStyler1">Dias Ultima captura</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('bitacora_residuo-create')) 
		{{ link_to_route('bitacora_residuo.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
