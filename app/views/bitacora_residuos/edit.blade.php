...
{{ Form::model($bitacora_residuo, array('class' => 'form', 'method' => 'PUT', 'url' => 'bitacora_residuo/update/'.$bitacora_residuo->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('bitacora_residuo.index', 'Cancelar', $bitacora_residuo->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
