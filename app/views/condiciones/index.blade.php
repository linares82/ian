...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('condicione.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
		...
		<thead>
			<tr>
				...
				<th field="condicion" sortable="true">Condicion</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('condicione-create')) 
		{{ link_to_route('condicione.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
