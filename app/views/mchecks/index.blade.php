...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('mcheck.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
		...
		<thead>
			<tr>
				...
				<th field="requisito" sortable="true">Requistio</th>
				<th field="rnc" sortable="true">RNC</th>
				<th field="minimo_vsm" sortable="true">Minimo VSM</th>
				<th field="maximo_vsm" sortable="true">Maximo VSM</th>
				<th field="orden" sortable="true">Orden</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('mcheck-create')) 
		{{ link_to_route('mcheck.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
