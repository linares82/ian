...
{{ Form::open(array('route' => 'aa_proceso.store', 'class' => 'form')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_2cols @if ( $errors->has('detalle')) has-error @endif">
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('aa_proceso.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
