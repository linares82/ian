...
{{ Form::open(array('route' => 'a_rr_amb_doc.store', 'class' => 'form')) }}
        ...
        <div class="row_1 @if ( $errors->has('archivo')) has-error @endif">
            ...
            {{ $errors->first('archivo', '<div class="errorMessage">:message</div>') }}
				...
				<div class="row_buttons">
					  ...
					  {{ link_to_route('a_rr_amb_doc.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
				</div>
			</div>
    </div>
