...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('efecto.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="efecto" sortable="true">Ponderación del impacto</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('efecto-create')) 
		{{ link_to_route('efecto.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
		...
		<div>
			...
			Efecto: <input id="efectoBox" class="easyui-textbox" style="width:80px">
