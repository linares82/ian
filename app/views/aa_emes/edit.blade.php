...
{{ Form::model($aa_eme, array('class' => 'form', 'method' => 'PUT', 'url' => 'aa_eme/update/'.$aa_eme->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ( $errors->has('eme')) has-error @endif">
            {{ Form::label('eme', 'Eme:') }}
              {{ Form::text('eme', Input::old('eme'), array('placeholder'=>'Eme')) }}
            {{ $errors->first('eme', '<div class="errorMessage">:message</div>') }}
        </div>
...
<div class="row_buttons">
  ...
  {{ link_to_route('aa_eme.index', 'Cancelar', $aa_eme->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
