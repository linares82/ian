...
{{ Form::model($ln_dossier, array('class' => 'form', 'method' => 'PUT', 'url' => 'ln_dossier/update/'.$ln_dossier->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('ln_dossier.index', 'Cancelar', $ln_dossier->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
