...
{{ Form::open(array('route' => 'm_imp_real.store', 'class' => 'form')) }}
        ...
        <div class="row_1 @if ( $errors->has('usu_alta_id')) has-error @endif">
            ...
            {{ $errors->first('usu_alta_id', '<div class="errorMessage">:message</div>') }}
				...
				<div class="row_buttons">
					  ...
					  {{ link_to_route('m_imp_real.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
				</div>
			</div>
    </div>
