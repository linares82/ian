...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('bitacora_planta.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="planta" sortable="true">Fuente Fija</th>
				<th field="fecha" sortable="true">Fecha</th>
				<th field="turno" sortable="true">Turno</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('bitacora_planta-create')) 
		{{ link_to_route('bitacora_planta.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
