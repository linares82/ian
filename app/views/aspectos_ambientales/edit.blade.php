...
{{ Form::model($aspectos_ambientale, array('class' => 'form', 'method' => 'PUT', 'url' => 'aspectos_ambientale/update/'.$aspectos_ambientale->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('aspectos_ambientale.index', 'Cancelar', $aspectos_ambientale->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
