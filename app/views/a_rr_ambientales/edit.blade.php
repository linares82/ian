...
{{ Form::model($a_rr_ambientale, array('class' => 'form', 'method' => 'POST', 'url' => 'a_rr_ambientale/update/'.$a_rr_ambientale->id, 'id'=>'f_rr_ambientales', 'files'=>true)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('a_rr_ambientale.index', 'Cancelar', $a_rr_ambientale->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
        ...
        <div class="datagrid row">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $d->documento }}</td>
                        <td><a href="{{ asset('uploads/'.$cia.'/'.$d->usu_alta_id.'/a_rr_ambientales_doc/'.$d->archivo) }}" target='_blank'>{{ $d->archivo }}</a></td>
                        <td>{{ link_to_route('a_rr_amb_doc.destroy', 'Eliminar', $parameters = array('id'=>$d->id), $attributes = array()) }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table
