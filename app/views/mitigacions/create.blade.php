...
{{ Form::open(array('route' => 'mitigacion.store', 'class' => 'form')) }}
            ...
            <div class="col-sm-10">
              {{ Form::input('number', 'usu_mod_is', Input::old('usu_mod_is'), array('class'=>'form-control')) }}
				...
				<div class="row_buttons">
					  ...
					  {{ link_to_route('mitigacion.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
				</div>
			</div>
    </div>
