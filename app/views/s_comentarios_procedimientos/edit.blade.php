...
{{ Form::model($s_comentarios_procedimiento, array('class' => 'form', 'method' => 'PUT', 'url' => 's_comentarios_procedimiento/update/'.$s_comentarios_procedimiento->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('s_comentarios_procedimiento.index', 'Cancelar', $s_comentarios_procedimiento->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
