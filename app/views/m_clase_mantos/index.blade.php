...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('m_clase_manto.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="clase_manto" sortable="true">Clase</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('m_clase_manto-create')) 
		{{ link_to_route('m_clase_manto.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
