...
{{ Form::open(array('route' => array('rev_documentoal_ln.store', $rev_documental), 
                    'class' => 'form', 'files'=>true, 'id'=>'f_rev_documentoal_lns')) }}
    <div class="easyui-tabs" style="width:auto;height:auto;">
		...
		<div class="row_buttons">
			  ...
			  {{ link_to_route('rev_documentoal_ln.index', 'Cancelar', array('id'=>$rev_documental), array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
		</div>
	</div>
</div>
