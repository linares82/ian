...
{{ Form::model($duracion_accion, array('class' => 'form', 'method' => 'PUT', 'url' => 'duracion_accion/update/'.$duracion_accion->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('duracion_accion.index', 'Cancelar', $duracion_accion->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
