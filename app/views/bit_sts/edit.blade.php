...
{{ Form::model($bit_st, array('class' => 'form', 'method' => 'PUT', 'url' => 'bit_st/update/'.$bit_st->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('bit_st.index', 'Cancelar', $bit_st->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
