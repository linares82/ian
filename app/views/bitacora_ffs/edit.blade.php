...
{{ Form::model($bitacora_ff, array('class' => 'form', 'method' => 'PUT', 'url' => 'bitacora_ff/update/'.$bitacora_ff->id)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_buttons">
          ...
          {{ link_to_route('bitacora_ff.index', 'Cancelar', $bitacora_ff->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
