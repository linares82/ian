...
{{ Form::open(array('route' => 'tweet.store', 'class' => 'form')) }}
        ...
        <div class="row_1 @if ( $errors->has('usu_mod_id')) has-error @endif">
            ...
            {{ $errors->first('usu_mod_id', '<div class="errorMessage">:message</div>') }}
				...
				<div class="row_buttons">
					  ...
					  {{ link_to_route('tweet.index', 'Cancelar', $parameters=null, array('class' => 'easyui-linkbutton', 'style'=>'height:28px;width:100px;')) }}
				</div>
			</div>
    </div>
