...
{{ Form::model($entidad, array('class' => 'form', 'method' => 'PUT', 'url' => 'entidad/update/'.$entidad->id, 'files' => true)) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row_1 @if ($errors->has('rzon_social')) has-error @endif">
            ...
            @if ($errors->has('rzon_social')) <div class="errorMessage">{{ $errors->first('rzon_social') }}</div> @endif
        </div>
    ...
    <div class="row_buttons">
      ...
      {{ link_to_route('entidad.index', 'Cancelar', $entidad->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
    </div>
