...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('aa_aspecto.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="aspectos" sortable="true">Aspecto</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('aa_aspecto-create')) 
		{{ link_to_route('aa_aspecto.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
