...
{{ Form::model($reversibilidad, array('class' => 'form', 'method' => 'PUT', 'url' => 'reversibilidad/update/'.$reversibilidad->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('reversibilidad.index', 'Cancelar', $reversibilidad->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
