...
{{ Form::model($ln_caracteristica, array('class' => 'form', 'method' => 'PUT', 'url' => 'ln_caracteristica/update/'.$ln_caracteristica->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('ln_caracteristica.index', 'Cancelar', $ln_caracteristica->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
