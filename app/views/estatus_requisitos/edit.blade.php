...
{{ Form::model($estatus_requisito, array('class' => 'form', 'method' => 'PUT', 'url' => 'estatus_requisito/update/'.$estatus_requisito->id)) }}
...
<div class="row_buttons">
  ...
  {{ link_to_route('estatus_requisito.index', 'Cancelar', $estatus_requisito->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
</div>
