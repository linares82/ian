...
@section('contenido_tab')
	...
	<table id="dg" class="easyui-datagrid" style="width:700px;height:200px"
			...
			url:'{{route('m_tpo_manto.contentListIndex', null)}}',autoRowHeight:false,pageSize:50, 
			pagination:true"
			fit="true" fitColumns="true" >
		<thead>
			<tr>
				<th field="id" sortable="true">Id</th>
				<th field="tpo_manto" sortable="true">Tipo</th>
	...
	<div id="toolbar">
		<div>
		@if (Sentry::getUser()->hasAccess('m_tpo_manto-create')) 
		{{ link_to_route('m_tpo_manto.create', 'Crear', null, array('class' => 'easyui-linkbutton', 'iconCls'=>'icon-add')) }}
		@endif
