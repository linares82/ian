...
{{ Form::model($check, array('class' => 'form', 'method' => 'POST', 'url' => 'check/update/'.$check->id, 'id'=>'f_check')) }}
     <div class="easyui-tabs" style="width:auto;height:auto;">
        ...
        <div class="row" style="clear:left;width:92%">
            ...
            {{ Form::select('normas[]', $normas_ls, $normas_seleccionadas, array('multiple'=>True,
            'id'=>'normas', 'style'=>'width:90%'), Input::old('normas[]')) }}
        </div>

        <div class="row_buttons">
          {{ Form::submit('Actualizar', array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
          {{ link_to_route('check.index', 'Cancelar', $check->id, array('class' => 'easyui-linkbutton', 'style'=>'height:30px;width:100px;')) }}
        </div>
