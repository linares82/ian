...
class CreateBitacoraAccidentesTable extends Migration {
	...
	public function up()
	{
		Schema::create('bitacora_accidentes', function(Blueprint $table) {
			$table->increments('id');
			...
			$table->foreign('accidente_id')->references('id')->on('cs_accidentes');
	...
	{
		Schema::drop('bitacora_accidentes');
	}
