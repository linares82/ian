...
$(document).ready(function()
{
    $(document).on('click', '.add-input', function()
    {
        ...
        {
            $selected.remove();
            var html = '<div class="form-group"> <p class="input-group"> <span class="input-group-addon"> <span class="remove-input easyui-linkbutton" data-options="iconCls:\'icon-removes\'"> <a href="#" class="easyui-linkbutton" data-options="iconCls:\'icon-removes\'">Quitar</a> </span> </span> </p> <input readonly type="text" class="form-control" name="'+permissionId+'" value="'+label+'"/> </div> <br/>';
