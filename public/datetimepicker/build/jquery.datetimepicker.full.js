		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				month_picker = $('<div class="xdsoft_monthpicker" ><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button>' +
					'<div class="xdsoft_label xdsoft_month" style="color:#000;"><span></span><i></i></div>' +
					'<div class="xdsoft_label xdsoft_year" style="color:#000;"><span></span><i></i></div>' +
				...
				monthselect = $('<div class="xdsoft_select xdsoft_monthselect" style="color:#000;"><div ></div></div>'),
				yearselect = $('<div class="xdsoft_select xdsoft_yearselect" style="color:#000;"><div></div></div>'),
